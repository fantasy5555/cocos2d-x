...
struct WidgetOptions FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Position *position() const {
    return GetStruct<const Position *>(VT_POSITION);
  }
...
struct EasingData FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<const Position *> *points() const {
    return GetPointer<const flatbuffers::Vector<const Position *> *>(VT_POINTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
